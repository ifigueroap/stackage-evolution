...
OUTPUT_JSONL="state_catalog.jsonl"
INSTRUCTIONS_PATH = "instructions/instructions_state.md"
...
DF_FILES = get_monad_files2(
    files_df,
    "Control.Monad.State"
).reset_index(drop=True)

DF_FILES["sample_number"] = range(1, len(DF_FILES) + 1)
